...
public:
    ...
    void setupUi(QWidget *gui_main)
    {
        ...
        MyGUI_box->setObjectName("MyGUI_box");
        Mygui_left_box = new QVBoxLayout();
        Mygui_left_box->setObjectName("Mygui_left_box");
        system_name = new QLabel(gui_main);
        system_name->setObjectName("system_name");
        ...
        main_right_box->setObjectName("main_right_box");
        ...
        textLocalIP->setObjectName("textLocalIP");
        ...
        textLocalPOrt->setObjectName("textLocalPOrt");
        ...
        people_signed_table_box->setObjectName("people_signed_table_box");
        people_signed_table_box->setContentsMargins(2, 0, 2, -1);
        figLabel1 = new QLabel(gui_main);
        figLabel1->setObjectName("figLabel1");
        ...
        people_unsigned_box->setObjectName("people_unsigned_box");
        people_unsigned_box->setContentsMargins(2, 0, 2, -1);
        figLabel2 = new QLabel(gui_main);
        figLabel2->setObjectName("figLabel2");
