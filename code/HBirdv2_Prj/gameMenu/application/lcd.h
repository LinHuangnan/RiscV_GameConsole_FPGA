...
void LCD_DrawRectangle(int16_t x1, int16_t y1, uint16_t w, uint16_t h,uint16_t color);		   				//画矩形
void LCD_Fill(int16_t sx,int16_t sy,uint16_t w,uint16_t h,uint16_t color);		   				//填充单色
