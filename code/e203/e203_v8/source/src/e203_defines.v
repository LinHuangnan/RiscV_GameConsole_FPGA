...
//user macro
`define RCV_UP 8'h46
`define RCV_DOWN 8'h15
`define RCV_LEFT 8'h44
`define RCV_RIGHT 8'h43
`define RCV_PLAY 8'h40
`define RCV_BACK 8'h4a
`define RCV_VOL_P 8'h07
`define RCV_VOL_N 8'h09
